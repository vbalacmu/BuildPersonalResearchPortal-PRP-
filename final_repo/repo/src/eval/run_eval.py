...
# In final_repo, this file lives under repo/src/eval/
# so the project root (with data/, logs/, etc.) is two levels up.
...
def run_eval(model_name: str = "ollama"):
    ...
    # In final_repo, evaluation artifacts live alongside this module under src/eval/
    out_path = REPO_ROOT / "src" / "eval" / "phase2_eval_results.json"
